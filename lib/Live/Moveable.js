...
var Moveable = function (_React$Component) {
  _inherits(Moveable, _React$Component);

  function Moveable(props) {
    _classCallCheck(this, Moveable);

    var _this = _possibleConstructorReturn(this, (Moveable.__proto__ || Object.getPrototypeOf(Moveable)).call(this, props));
